...
- Fill in a short description on https://github.com/lizardsystem/qgispluginreleaser or
  https://github.com/nens/qgispluginreleaser if you haven't done so already.
...
- Check https://github.com/nens/qgispluginreleaser/settings/collaboration if the team
  "Nelen & Schuurmans" has access.

- Add a new jenkins job at
  http://buildbot.lizardsystem.nl/jenkins/view/djangoapps/newJob or
  http://buildbot.lizardsystem.nl/jenkins/view/libraries/newJob . Job name
  should be "qgispluginreleaser", make the project a copy of the existing "lizard-wms"
  project (for django apps) or "nensskel" (for libraries). On the next page,
  change the "github project" to ``https://github.com/nens/qgispluginreleaser/`` and
  "repository url" fields to ``git@github.com:nens/qgispluginreleaser.git`` (you might
